...
export const en = {
  ...
  'pe.title': 'Product & pricing',
  'pe.desc':
    'Package this assessment into pricing tiers, each a card with its own title, price (in Rupiah), button and image, and a pricing type (free, paid, or voucher).',
  'pe.customize': 'Customize',
  'pe.savedPublished':
    'Product saved and published. Its tiers are live on the landing page.',
  'pe.savedDraft': 'Product saved as a draft.',
  'pe.published': 'Product published.',
  'pe.unpublished': 'Product unpublished.',
  'pe.errLoad': 'Failed to load product',
  'pe.errSave': 'Failed to save',
  'pe.errUpdate': 'Failed to update',
  'pe.noProduct':
    "No product yet. Set one up to show pricing tiers on this assessment's landing page.",
  'pe.setup': 'Set up product',
  'pe.noTiersEnabled': 'No tiers enabled',
  'pe.kindFree': 'Free',
  'pe.kindPaid': 'Paid',
  'pe.kindVoucher': 'Voucher (redeem a code)',
  'pe.name': 'Product name',
  'pe.status': 'Status',
  'pe.statusDraft': 'Draft (hidden)',
  'pe.statusPublished': 'Published (live on landing)',
  'pe.descOptional': 'Description (optional)',
  'pe.descPh': 'Short summary shown above the tiers.',
  'pe.tiers': 'Pricing tiers',
  'pe.addTier': 'Add tier',
  'pe.tierHelp':
    'Prices are in Rupiah and charged for real. Each Paid tier is bought on its own at its own price, unlocking that tier’s bonus content for the buyer. A Voucher tier makes the assessment redeemable with a code, and a Free tier keeps it open to everyone.',
  'pe.enabled': 'Enabled',
  'pe.highlight': 'Highlight',
  'pe.removeTier': 'Remove tier',
  'pe.tierTitle': 'Title',
  'pe.tierTitlePh': 'e.g. Full access',
  'pe.pricingType': 'Pricing type',
  'pe.priceLabel': 'Price label',
  'pe.priceLabelPh': 'e.g. Rp 29.000 or Free',
  'pe.priceRp': 'Price in Rp (0 = hide)',
  'pe.tierDesc': 'Description',
  'pe.tierDescPh': 'One line describing this tier.',
  'pe.tierImage': 'Tier image / logo (optional)',
  'pe.tierImageHelp':
    'Shown between the title and the button. PNG, SVG, JPG, JPEG or WEBP · up to 5 MB.',
  'pe.buttonLabel': 'Button label',
  'pe.buttonLabelPh': 'e.g. Get started',
  'pe.noTiers': 'No tiers. Add at least one to show pricing on the landing page.',
  'pe.packages': 'Company voucher packages',
  'pe.addPackage': 'Add package',
  'pe.packagesHelp':
    "Batch/seat packages a company buys from their balance to get voucher codes. Price each package in Rupiah, set it cheaper per seat than the individual cost. Buyers purchase these from their dashboard's Team-vouchers section.",
  'pe.packageName': 'Package name',
  'pe.packageNamePh': 'e.g. Team 10-pack',
  'pe.seats': 'Seats',
  'pe.packagePrice': 'Price (Rp)',
  'pe.removePackage': 'Remove package',
  'pe.perSeat': 'per seat',
  'pe.packageImage': 'Package image / logo (optional)',
  'pe.packageImageHelp':
    'Shown on the package card on the landing page. PNG, SVG, JPG, JPEG or WEBP · up to 5 MB.',
  'pe.noPackages': 'No packages. Add one to let companies buy voucher codes in bulk.',
  'pe.bonus': 'Bonus content',
  'pe.bonusHelp':
    'Videos and text unlocked for buyers of this tier, shown on their result page after they finish. Videos accept a YouTube, Vimeo or direct link.',
  'pe.text': 'Text',
  'pe.video': 'Video',
  'pe.moveUp': 'Move up',
  'pe.moveDown': 'Move down',
  'pe.removeBlock': 'Remove block',
  'pe.textPh': 'Write a paragraph for buyers of this tier…',
