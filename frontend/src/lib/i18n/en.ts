...
export const en = {
  ...
  // Landing page editor
  'le.title': 'Landing page',
  'le.view': 'View',
  'le.customize': 'Customize',
  'le.publishHint': 'Publish this assessment to make its landing page live at',
  'le.savedNotice': 'Landing page saved.',
  'le.resetNotice': 'Landing page reset to default.',
  'le.brand': 'Brand',
  'le.brandName': 'Brand name',
  'le.monogram': 'Monogram (1–2 letters)',
  'le.logo': 'Landing page logo',
  'le.favicon': 'Favicon (browser tab icon)',
  'le.faviconHelp':
    'Shown in the browser tab for your landing page. A square PNG, SVG or ICO-style image works best. PNG, SVG, JPG, JPEG or WEBP · up to 5 MB.',
  'le.primary': 'Primary',
  'le.secondary': 'Secondary',
  'le.accent': 'Accent',
  'le.scheme': 'Color scheme',
  'le.schemeAuto': 'Auto (follow device)',
  'le.schemeLight': 'Light',
  'le.schemeDark': 'Dark',
  'le.corners': 'Corners',
  'le.cornersSharp': 'Sharp',
  'le.cornersSoft': 'Soft',
  'le.cornersRound': 'Round',
  'le.hero': 'Hero',
  'le.eyebrow': 'Eyebrow',
  'le.headline': 'Headline',
  'le.subtitle': 'Subtitle',
  'le.description': 'Description',
  'le.heroPhoto': 'Landing page / hero photo (optional)',
  'le.heroPhotoHelp':
    'Shown as the hero image, replacing the default preview. PNG, SVG, JPG, JPEG or WEBP · up to 5 MB.',
  'le.primaryBtn': 'Primary button',
  'le.secondaryBtn': 'Secondary button',
  'le.aboutSection': 'About section',
  'le.showAbout': 'Show About section',
  'le.aboutHelp':
    'A section with your title and description on the left and a photo on the right.',
  'le.titleField': 'Title',
  'le.aboutTitlePh': 'e.g. About this assessment',
  'le.aboutBodyPh':
    "Tell visitors who you are and what they'll get. Line breaks are kept.",
  'le.aboutPhoto': 'About photo',
  'le.aboutPhotoHelp':
    'Shown on the right of the About section. A 4:3 (landscape) image works best. PNG, SVG, JPG, JPEG or WEBP · up to 5 MB.',
  'le.aboutHidden': 'The About section is hidden on your landing page.',
  'le.benefitsSection': 'Benefits section',
  'le.showBenefits': 'Show Benefits section',
  'le.benefitsHelp':
    'A titled grid of cards, each with an image, a heading and a short description (e.g. “4 Ways You Can Benefit…”).',
  'le.sectionTitle': 'Section title',
  'le.benefitsTitlePh': 'e.g. 4 Ways You Can Benefit from this assessment',
  'le.card': 'Card',
  'le.remove': 'Remove',
  'le.heading': 'Heading',
  'le.benefitHeadingPh': 'e.g. Identifying',
  'le.benefitDescPh': 'What this benefit gives the reader.',
  'le.iconImage': 'Icon / image',
  'le.iconImageHelp':
    'Shown at the top of the card. A square icon/illustration works best. PNG, SVG, JPG, JPEG or WEBP · up to 5 MB.',
  'le.addCard': '+ Add card',
  'le.benefitsHidden': 'The Benefits section is hidden on your landing page.',
  'le.contactSection': 'Contact section',
  'le.showContact': 'Show Contact section',
  'le.contactHelp':
    'A clickable title in the footer that opens a WhatsApp chat. When the About section is on, it also gets a button linking here.',
  'le.contactTitlePh': 'e.g. Contact us',
  'le.contactName': 'Contact name',
  'le.contactNamePh': 'e.g. James Gwee',
  'le.whatsapp': 'WhatsApp number',
  'le.whatsappPh': 'e.g. 628123456789 (include country code)',
  'le.contactHidden': 'The Contact section is hidden on your landing page.',
  'le.closing': 'Closing call to action',
  'le.showClosing': 'Show closing section',
  'le.button': 'Button',
  'le.closingHidden':
    'The closing call-to-action section is hidden on your landing page.',
  'le.seo': 'Search & social (SEO)',
  'le.pageTitle': 'Page title',
  'le.metaDesc': 'Meta description',
  'le.save': 'Save landing page',
  'le.saving': 'Saving…',
  'le.cancel': 'Cancel',
  'le.reset': 'Reset to default',

  // Learning resources editor
  'lr.title': 'Learning resources',
  'lr.help':
    'Curate an independent library per result. Shared resources appear for every result; each result profile below gets its own personalized set. Videos support YouTube, Vimeo, or a direct file link.',
  'lr.onlyShared':
    "Only shared resources are available right now. Define this assessment's result categories (above) to give each personality result its own resource library.",
  'lr.shared': 'Shared resources',
  'lr.unassigned': 'unassigned',
  'lr.resourcesWord': 'resources',
  'lr.add': 'Add',
  'lr.remove': 'Remove',
  'lr.accessAria': 'Access level',
  'lr.accessFree': 'Free (shown on result)',
  'lr.accessLocked': 'Locked (unlocks with access)',
  'lr.titlePh': 'Title',
  'lr.titleVideoPh': 'Title (e.g. Leadership Introduction)',
  'lr.titleAria': 'Resource title',
  'lr.urlAria': 'Resource URL',
  'lr.descPh': 'Short description (optional)',
  'lr.descAria': 'Resource description',
  'lr.providerAria': 'Video provider',
  'lr.durationPh': 'Duration (e.g. 12 min)',
  'lr.durationAria': 'Video duration',
  'lr.thumbPh': 'Thumbnail URL (optional)',
  'lr.thumbAria': 'Video thumbnail URL',
  'lr.provAuto': 'Auto-detect',
  'lr.provYoutube': 'YouTube',
  'lr.provVimeo': 'Vimeo',
  'lr.provMp4': 'Direct MP4',
  'lr.provFile': 'Uploaded file',
  'lr.provExternal': 'External',
};
